...
.hm {
	background-image: url('<%=ORSView.APP_CONTEXT%>/img/p3bg10.jpg');
	background-size: 100%;
}
</style>
</head>
<body class="hm">
	...
	<div>
		<form action="<%=ORSView.MARKSHEET_LIST_CTL%>" method="post">
			...
			%>
			<center>
				<h1 style="color: white;"> Marksheet List</h1>
			</center>
			...
			<div class="row">
				...
				<span><b style="color:white">Name :</b></span>
				<div class="col-sm-2">
					<input class="form-control" type="text" name="name"
						placeholder="Enter name" class="p1"
						value="<%=ServletUtility.getParameter("name", request)%>">
				</div>
				<span><b style="color:white">Roll No:</b></span>
